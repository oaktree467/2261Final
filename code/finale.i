...
# 4 "finale.c" 2
# 1 "finalecollision.h" 1
# 20 "finalecollision.h"
...
void loadFinale() {
    ...
    *(volatile unsigned short*)0x400010A |= 2 | (1<<6);
...
void initFinaleSprites() {
    ...
    finaleSpritesArr[0].attr0_shape = 0;
    finaleSpritesArr[0].attr1_size = 3;
    finaleSpritesArr[0].worldCol = 15;
    finaleSpritesArr[0].worldRow = 29;
    finaleSpritesArr[0].hide = 0;
    finaleSpritesArr[0].collisionColor = 0x7F60;
    ...
    finaleSpritesArr[1].attr0_shape = 1;
    finaleSpritesArr[1].attr1_size = 2;
    finaleSpritesArr[1].worldCol = 66;
    finaleSpritesArr[1].worldRow = 48;
    finaleSpritesArr[1].hide = 0;
    finaleSpritesArr[1].collisionColor = 0x03FF;
    ...
    finaleSpritesArr[2].attr0_shape = 0;
    finaleSpritesArr[2].attr1_size = 1;
    ...
    finaleSpritesArr[3].attr0_shape = 0;
    finaleSpritesArr[3].attr1_size = 2;
    ...
    finaleSpritesArr[4].attr0_shape = 0;
    finaleSpritesArr[4].attr1_size = 2;
...
void drawPersistentSprites() {
    for (int i = 2; i < 5; i++) {
        shadowOAM[i + 3].attr0 = ((finaleSpritesArr[i].screenRow & 0xFF) | (1<<13) | ((finaleSpritesArr[i].attr0_shape) << 14));
        shadowOAM[i + 3].attr1 = ((finaleSpritesArr[i].screenCol & 0x1FF)| (finaleSpritesArr[i].attr1_size) << 14);
        shadowOAM[i + 3].attr2 = ((0)<<12) | ((finaleSpritesArr[i].sheetRow)*32+(finaleSpritesArr[i].sheetCol * 2)) | ((2)<<10);
    }
}
...
void selectArrow() {
    ...
    switch (replyNum) {
        case (1):
            messagescreenMap[intervalOne] = messagescreenMap[749];
            break;
        case (2):
            messagescreenMap[intervalTwo] = messagescreenMap[749];
            break;
        case (3):
            messagescreenMap[intervalThree] = messagescreenMap[749];
            break;
    }
...
void chapterThreeIntro() {
    ...
    unsigned short chapter3bgMapCopy[2048];
    memcpy(chapter3bgMapCopy, chapter3bgMap, 2048);

    for (int i = 0; i < 700; i++) {
        chapter3bgMapCopy[i] = chapter3bgMap[701];
        if (i % 32 == 0) {
            DMANow(3, chapter3bgMapCopy, &((screenblock *)0x6000000)[24], ((1 << 30) | (2048 / 2)));
        }
    }
